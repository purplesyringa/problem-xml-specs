// Compare output and answer as a sequence of real numbers. Ignores whitespaces mismatchings. Two
// real numbers are considered equals if their absolute or relative error doesn't exceed 1E-6.
#include "testlib.h"
#include <cmath>
